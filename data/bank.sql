...
insert into customer values ('Johnson', 'New Street', 'Guimarães');
...
insert into branch values ('Ship Terminal', 'Setúbal', 0400000);
insert into branch values ('Clérigos',   'Oporto',   3900000);
